 ...
 */
 async function help() {
  ...
  console.log("");
  console.log("  - \x1b[32mdev_build_css\x1b[0m : compile le fichier styles/scss/default.scss dans styles/default.css");    
  console.log("");
  console.log("  - \x1b[32mwatch\x1b[0m     : Observation des fichiers sass et compilation auto en cas de modifications");
  console.log("  - \x1b[32msyncWatch\x1b[0m : ");
  ...
  console.log("");
  console.log("  - \x1b[32mprod_clean\x1b[0m     : Nettoyage du dossier \"dist\""); 
  console.log("  - \x1b[32mprod_minify_js\x1b[0m : Minification des fichiers javascript");
  console.log("");
